...
(define (add-tail t)
  (match t
    ...
    [_ (error (format "add-saved-registers-stkTokens:  Failed match.\n No valid tail: ~a" t))]))
...
(module+ test
  ...
  (check-add add-tail
             ...
             '(begin (set! x.1 y.2) (begin (set! a0 x.1) (jump-return cra cfp a0 cs1)))
  ...
  (check-add add-tail
             ...
             '(if (true)
                  (begin (set! a0 x.1) (jump-return cra cfp a0 cs1))
                  (begin (set! a0 y.2) (jump-return cra cfp a0 cs1)))
  ...
  (check-add-values-2 add-tail-info
                      ...
                      '((allocatedFvars (fv0 fv1 fv2)) (new-frames ()) (paramSize 0)) '(begin (set! a0 x.1) (jump-return cra cfp a0 cs1)) 
  ...
  (check-add-values-2 add-tail-info
                      '((new-frames ()) (paramSize 2)) '(begin (set! x.1 y.2) (begin (set! a0 x.1) (jump-return cra cfp a0))) 
                      '((allocatedFvars (fv2 fv3 fv4)) (new-frames ()) (paramSize 2)) '(begin (set! x.1 y.2) (begin (set! a0 x.1) (jump-return cra cfp a0 cs1))) 
                      ...
                      '(begin
                         (return-point
                          ...
                          (begin
                            ...
                            (jump-call L.swap.1 cfp cra a1 a2)))
                         (jump-return cra cfp a0 cs1))
                      "add-tail-info: succes-05: call param-size 3")
  ;(add-func f)
  ;succes
  (check-add add-func
             '(define L.odd.1
