...
(define/contract (expose-basic-blocks p) (-> nested-asm-lang? block-pred-lang?)
  ;(logln "begin")
  ;(logln p)
  ;(logln "start")
  (match p
...
;expose-basic-blocks
  ...
  (check-expose (expose-basic-blocks '(module () (begin (set! a0 a1) (set! a1 a0) (if (if (< a0 a1) (= a0 a1) (= a1 a0))
                                                                                      (begin (set! a0 a0) (jump cra))
                                                                                      (begin (set! a0 a1) (jump cra))))))
                '(module () (define L.tmp.0 (begin (set! a0 a1) (set! a1 a0) (if (< a0 a1) (jump L.tmp.3) (jump L.tmp.4))))
                   (define L.tmp.1 (begin (set! a0 a0) (jump cra)))
                   (define L.tmp.2 (begin (set! a0 a1) (jump cra)))
                   (define L.tmp.3 (if (= a0 a1) (jump L.tmp.1) (jump L.tmp.2)))
                   (define L.tmp.4 (if (= a1 a0) (jump L.tmp.1) (jump L.tmp.2))))
                "expose-basic-blocks: succes-07: begin tail")
  (check-expose (expose-basic-blocks '(module () (begin (set! a2 a4) (if (> a0 a1) (set! a0 a1) (set! a1 a0)) (set! a2 a4) (if (if (< a0 a1) (= a0 a1) (= a1 a0))
                                                                                                                            (begin (set! a0 a0) (jump cra))
                                                                                                                            (begin (set! a0 a1) (jump cra))))))
                '(module () (define L.tmp.0 (begin (set! a2 a4) (if (> a0 a1) (jump L.tmp.1) (jump L.tmp.2))))
                   (define L.tmp.1 (begin (set! a0 a1) (jump L.tmp.3)))
                   (define L.tmp.2 (begin (set! a1 a0) (jump L.tmp.3)))
                   (define L.tmp.3 (begin (set! a2 a4) (if (< a0 a1) (jump L.tmp.6) (jump L.tmp.7))))
  ...
  (check-expose (expose-basic-blocks '(module () (begin (set! a2 a4) (if (if (< a0 a1) (= a0 a1) (= a1 a0)) (set! a0 a1) (set! a1 a0)) (set! a2 a4)
                                                     (begin (set! a0 a0) (jump cra)))))
                '(module () (define L.tmp.0 (begin (set! a2 a4) (if (< a0 a1) (jump L.tmp.4) (jump L.tmp.5))))
                   (define L.tmp.1 (begin (set! a0 a1) (jump L.tmp.3)))
                   (define L.tmp.2 (begin (set! a1 a0) (jump L.tmp.3)))
                   (define L.tmp.4 (if (= a0 a1) (jump L.tmp.1) (jump L.tmp.2)))
                   (define L.tmp.5 (if (= a1 a0) (jump L.tmp.1) (jump L.tmp.2)))
                   (define L.tmp.3 (begin (set! a2 a4) (begin (set! a0 a0) (jump cra)))))
                "expose-basic-blocks: succes-09: begin tail if effect with if pred")
  (check-expose (expose-basic-blocks '(module () (if (begin (set! a0 a1) (set! a1 a0) (< a0 a1)) (begin (set! a0 a0) (jump cra)) (begin (set! a0 a1) (jump cra)))))
                '(module () (define L.tmp.0 (begin (set! a0 a1) (set! a1 a0) (if (< a0 a1) (jump L.tmp.1) (jump L.tmp.2))))
                   (define L.tmp.1 (begin (set! a0 a0) (jump cra)))
                   (define L.tmp.2 (begin (set! a0 a1) (jump cra))))
                "expose-basic-blocks: succes-10: begin pred in if tail")
  (check-expose (expose-basic-blocks '(module () (begin (set! a0 a1) (set! a1 a0) (begin (set! a2 a3) (set! a3 a2)) (begin (set! a0 a0) (jump cra)))))
                '(module () (define L.tmp.0 (begin (set! a0 a1) (set! a1 a0) (set! a2 a3) (set! a3 a2) (begin (set! a0 a0) (jump cra)))))
                 "expose-basic-blocks: succes-11: begin effect in begin tail")
  (check-expose (expose-basic-blocks '(module () (begin (set! a0 a1) (set! a1 a0) (begin (set! a2 a3) (begin (set! a3 a2) (set! a1 a2)) (set! a2 a1)) (begin (set! a0 a0) (jump cra)))))
                '(module () (define L.tmp.0 (begin (set! a0 a1) (set! a1 a0) (set! a2 a3) (set! a3 a2) (set! a1 a2) (set! a2 a1) (begin (set! a0 a0) (jump cra)))))
                "expose-basic-blocks: succes-12: nested begin effect in begin tail")
  (check-expose (expose-basic-blocks '(module ()
                                        (begin (set! a2 a4)
                                               (if (if (< a0 a1) (= a0 a1) (= a1 a0))
                                                   (set! a0 a1)
                                                   (set! a1 a0))
                                               (set! a2 a4)
                                               (if (if (< a0 a1) (= a0 a1) (= a1 a0))
                ...
                '(module () (define L.tmp.0 (begin (set! a2 a4) (if (< a0 a1) (jump L.tmp.4) (jump L.tmp.5))))
                   ...
                   (define L.tmp.4 (if (= a0 a1) (jump L.tmp.1) (jump L.tmp.2)))
                   (define L.tmp.5 (if (= a1 a0) (jump L.tmp.1) (jump L.tmp.2)))
                   (define L.tmp.3 (begin (set! a2 a4) (if (< a0 a1) (jump L.tmp.9) (jump L.tmp.10))))
                   (define L.tmp.6 (begin (set! a0 a1) (jump L.tmp.8)))
                   (define L.tmp.7 (begin (set! a1 a0) (jump L.tmp.8)))
                   (define L.tmp.9 (if (= a0 a1) (jump L.tmp.6) (jump L.tmp.7)))
                   (define L.tmp.10 (if (= a1 a0) (jump L.tmp.6) (jump L.tmp.7)))
                   (define L.tmp.8 (begin (set! a2 a1) (begin (set! a0 a0) (jump cra)))))
