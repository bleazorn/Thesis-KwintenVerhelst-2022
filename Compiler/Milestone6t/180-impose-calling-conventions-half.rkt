...
(define (impose-value v)
  (match v
    [`(call ,n ,a ...) (cond [(or (label? n) (aloc? n)) (let ([rp-label (freshRPLabel)])
                             ...
                             [(integer? n) n]
                             [else (error (format "impose-calling-conventions-half:  Failed match.\n No valid value call: ~a" v))])]
    [val val]))
...
(define (impose-effect e)
  (match e
    ...
    [_ (error (format "impose-calling-conventions-half:  Failed match.\n No valid effect: ~a" e))]))
...
(define (impose-tail t)
  (match t
    ...
    [`(call ,n ,a ...) (cond [(or (label? n) (aloc? n)) (let-values ([(regArg regPara) (get-registers a)]
...
(define (impose-entry e)
  ...
  (let ([tail (impose-tail e)])
    (let ([nInfo `(,(setNewFrames new-frame))])
      (values tail
              nInfo))))
...
(module+ test
  ...
  (check-impose impose-tail '(call L.swap.1 1 2) '(begin (set! a1 1) (set! a2 2) (jump-call L.swap.1 cfp cra a1 a2)) "impose-tail: succes-02: call less than available param" (current-parameter-registers))
  (check-impose impose-tail '(call L.swap.1 1 2) '(begin (set! fv0 2) (set! a1 1) (jump-call L.swap.1 cfp cra a1 fv0)) "impose-tail: succes-03: call more than available param" '(a1))
  (check-impose impose-tail '(call L.swap.1 1 2) '(begin (set! fv1 2) (set! fv0 1) (jump-call L.swap.1 cfp cra fv0 fv1)) "impose-tail: succes-04: call no available param" '())
  ...
  ;(impose-entry e)
  ;succes
  (check-impose-values-2 impose-entry 'x.1 '(begin (set! a0 x.1) (jump-return cra cfp a0)) '((new-frames ())) "impose-entry: succes-01: val" (current-parameter-registers))
  
  (check-impose-values-2 impose-entry '(call L.swap.1 1 2) '(begin (set! a1 1) (set! a2 2) (jump-call L.swap.1 cfp cra a1 a2)) '((new-frames ())) "impose-entry: succes-02: tail call less than available param" (current-parameter-registers))
  (check-impose-values-2 impose-entry '(call L.swap.1 1 2) '(begin (set! fv0 2) (set! a1 1) (jump-call L.swap.1 cfp cra a1 fv0)) '((new-frames ())) "impose-entry: succes-03: tail call more than available param" '(a1))
  (check-impose-values-2 impose-entry '(call L.swap.1 1 2) '(begin (set! fv1 2) (set! fv0 1) (jump-call L.swap.1 cfp cra fv0 fv1)) '((new-frames ())) "impose-entry: succes-04: tail call no available param" '())
  ...
  (check-impose-values-2 impose-entry '(begin (set! x.1 y.2) x.1) '(begin (set! x.1 y.2) (begin (set! a0 x.1) (jump-return cra cfp a0))) '((new-frames ())) "impose-entry: succes-08: begin" (current-parameter-registers))
  (check-impose-values-2 impose-entry
                         '(if (true) x.1 y.2)
                         '(if (true)
                              (begin (set! a0 x.1) (jump-return cra cfp a0))
  ...
  ;failure
  (check-impose-values-2 impose-entry '(call 0 1 2) 0 '((new-frames ())) "impose-entry: failure-01: call integer" (current-parameter-registers))
  (check-exn exn:fail? (thunk (impose-entry '(call x 1 2))) "impose-entry: failure-02: call error")
  ;(impose-func f)
  ;succes
  (check-impose impose-func
                '(define L.odd.1 (lambda (x.1 y.2) (call L.swap.2 x.1 y.2)))
                '(define L.odd.1
                   ((new-frames ()))
                   (begin
                     (set! x.1 a1)
                     (set! y.2 a2)
                     (begin (set! a1 x.1) (set! a2 y.2) (jump-call L.swap.2 cfp cra a1 a2))))
  ...
  (check-impose impose-func
                ...
                '(define L.odd.1
                   ...
                   (begin
                     (set! x.1 a1)
                     (set! y.2 fv0)
                     (begin (set! fv0 y.2) (set! a1 x.1) (jump-call L.swap.2 cfp cra a1 fv0))))
                ...
                '(define L.odd.1
                   ...
                   (begin
                     ...
                     (begin
                       (set! fv1 y.2)
                       (set! fv0 x.1)
                       (jump-call L.swap.2 cfp cra fv0 fv1))))
                "impose-func: succes-03: tail call no available param" '())
  (check-impose impose-func
                '(define L.odd.1 (lambda (x.1 y.2) (begin (set! x.1 (call L.swap.2 x.1 y.2)) x.1)))
                '(define L.odd.1
                   ((new-frames ()))
                   (begin
                     (set! x.1 a1)
