...
(define (uncover-func f)
  (match f
    [`(define ,l ,i ,t) `(define ,l ((locals ,(uncover-tail t '()))) ,t)]
    [_ #f]))
...
(define (uncover-locals p)
  (match p
    [`(module ,i ,f ... ,t) `(module ((locals ,(uncover-tail t '()))) ,@(map uncover-func f) ,t)]      ;TODO: check voor efficientie remove duplicates
    [_ #f]))
