...
(define (assign-func f)
  (match f
    [`(define ,l ((locals ,loc) (conflicts ,conf)) ,t) `(define ,l ((locals ,loc) (assignment ,(assign-recur loc conf '() conf))) ,t)]
    [_ #f]))
...
(define (assign-registers p)
  (match p
    [`(module ((locals ,loc) (conflicts ,conf)) ,f ... ,pro) `(module ((locals ,loc) (assignment ,(assign-recur loc conf '() conf))) ,@(map assign-func f) ,pro)]
    [_ #f]))
