...
(define (undead-effect e undead-outs)
  (let ([undead-out (if (null? undead-outs) '() (car undead-outs))]
    ...
    (match e
      ...
      [`(if ,p ,e1 ,e2) (let* ([u1 (undead-effect e1 `(,undead-out))]    ;'((u) (r))
...
(define (undead-func f)
  (match f
    [`(define ,l (,loc) ,t) `(define ,l ,(cons loc `((undead-out ,(car  (cdr (undead-tail t '(()))))))) ,t)]
    [_ #f]))
...
(define (undead-analysis p)
  (match p
    [`(module (,loc) ,f ... ,t) `(module ,(cons loc `((undead-out ,(car  (cdr (undead-tail t '(()))))))) ,@(map undead-func f) ,t)] ;ALs enkel halt instructi (x.1) ipv ((x.1))
