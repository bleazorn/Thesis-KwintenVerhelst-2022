...
;sequentialize-value
  ;succes
  (check-equal? (sequentialize-value '(if (true) x.1 y.2)) '(if (true) x.1 y.2) "sequentialize-value: succes-08: if")
  (check-equal? (sequentialize-value '(if (let ([x.1 1]) (true)) (false) (true))) '(if (begin (set! x.1 1) (true)) (false) (true)) "sequentialize-value: succes-09: if")
  (check-equal? (sequentialize-value '(if (true) (let ([x.1 1]) x.1) (true))) '(if (true) (begin (set! x.1 1) x.1) (true)) "sequentialize-value: succes-10: if")
  (check-equal? (sequentialize-value '(if (true) (false) (let ([x.1 1]) x.1))) '(if (true) (false) (begin (set! x.1 1) x.1)) "sequentialize-value: succes-11: if")
;sequentialize-tail
  ;succes
  (check-equal? (sequentialize-tail '(if (true) x.1 y.2)) '(if (true) x.1 y.2) "sequentialize-tail: succes-08: if")
  (check-equal? (sequentialize-tail '(if (let ([x.1 1]) (true)) (false) (true))) '(if (begin (set! x.1 1) (true)) (false) (true)) "sequentialize-tail: succes-09: if")
  (check-equal? (sequentialize-tail '(if (true) (let ([x.1 1]) x.1) (true))) '(if (true) (begin (set! x.1 1) x.1) (true)) "sequentialize-tail: succes-10: if")
  (check-equal? (sequentialize-tail '(if (true) (false) (let ([x.1 1]) x.1))) '(if (true) (false) (begin (set! x.1 1) x.1)) "sequentialize-tail: succes-11: if")
  )
