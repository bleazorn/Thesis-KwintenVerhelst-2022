...
(require "common/fvar.rkt"
         ...
         "180-impose-calling-conventions-secure.rkt"
         ...
         "020-generate-cheri-risc-v-stack-up.rkt"
...
(define (stkTokens l)
  (let ([wI (index-where l (lambda (a) (equal? wrap-cheri-risc-v-run-time a)))]
        [gI (index-where l (lambda (a) (equal? generate-cheri-risc-v a)))]
    ...
    (let ([switchedL (list-set
                      (list-set
                       ...
                       gI generate-cheri-risc-v-stack-up)
