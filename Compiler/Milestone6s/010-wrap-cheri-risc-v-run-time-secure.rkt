...
(define (initialize-got-label name loc)
  (string-append 
   ...
   "//pc\n"
   (indent-instr (format "li t4, 259"))
   (indent-instr (format "li t5, 0x80002100"))
   ...
   (indent-instr (format "li t5, 0x80002000"))
   (indent-instr (format "li t6, 0x100"))
   (indent-instr (format "csetoffset ct1, ct1, t5"))
   (indent-instr (format "CAndPerm ct1, ct1, t4"))
   ...
   (indent-instr (format "cincoffsetimm cgp, cgp, -~a" (* (add1 loc) (framesize))))))
